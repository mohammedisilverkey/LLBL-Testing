...
namespace practice.FactoryClasses
{
	...
	{
		private readonly practice.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, practice.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((practice.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public DepartmentEntityFactory() : base("DepartmentEntity", practice.EntityType.DepartmentEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public EmployeeEntityFactory() : base("EmployeeEntity", practice.EntityType.EmployeeEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new EmployeeEntity(fields); }
	}

	/// <summary>Factory to create new, empty ManagerEntity objects.</summary>
	[Serializable]
	public partial class ManagerEntityFactory : EntityFactoryBase2<ManagerEntity> 
	{
		/// <summary>CTor</summary>
		public ManagerEntityFactory() : base("ManagerEntity", practice.EntityType.ManagerEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new ManagerEntity(fields); }
	}
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(practice.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(practice.EntityType)))
			{
				var factory = GetFactory((practice.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the practice.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(practice.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case practice.EntityType.DepartmentEntity:
					return new DepartmentEntityFactory();
				case practice.EntityType.EmployeeEntity:
					return new EmployeeEntityFactory();
				case practice.EntityType.ManagerEntity:
					return new ManagerEntityFactory();
				default:
					return null;
			}
		}
	...
	{
		/// <summary>Gets the factory of the Entity type with the practice.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (practice.EntityType)Enum.Parse(typeof(practice.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((practice.EntityType)Enum.Parse(typeof(practice.EntityType), leftOperandEntityName, false), joinType, (practice.EntityType)Enum.Parse(typeof(practice.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (practice.EntityType)Enum.Parse(typeof(practice.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((practice.EntityType)entityTypeValue); }
