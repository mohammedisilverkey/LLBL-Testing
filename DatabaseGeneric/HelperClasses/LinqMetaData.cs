...
namespace practice.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((practice.EntityType)typeOfEntity)
			{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting ManagerEntity instances in the database.</summary>
		public DataSource2<ManagerEntity> Manager {	get { return new DataSource2<ManagerEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
